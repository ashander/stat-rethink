...
\centering{}\includegraphics{fig/hw2-null-v-prior} 
...
\hlstd{}\hlsymbol{pr.data}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{pr.data\usebox{\hlnormalsizeboxunderscore}fair}{\ }\hlkeyword{+}{\ }\hlsymbol{pr.data\usebox{\hlnormalsizeboxunderscore}loaded}\hspace*{\fill}\\
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{pr.loaded\usebox{\hlnormalsizeboxunderscore}data}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{pr.data\usebox{\hlnormalsizeboxunderscore}loaded}{\ }\hlkeyword{*}{\ }\hlsymbol{pr.loaded}\hlkeyword{/}\hlsymbol{pr.data}\hspace*{\fill}\\
\hlstd{}\hlsymbol{pr.loaded\usebox{\hlnormalsizeboxunderscore}data}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
## [1] 0.007145
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{pr.fair\usebox{\hlnormalsizeboxunderscore}data.norm}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{pr.fair\usebox{\hlnormalsizeboxunderscore}data}\hlkeyword{/}\hlkeyword{(}\hlsymbol{pr.fair\usebox{\hlnormalsizeboxunderscore}data}{\ }\hlkeyword{+}{\ }\hlsymbol{pr.loaded\usebox{\hlnormalsizeboxunderscore}data}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{pr.fair\usebox{\hlnormalsizeboxunderscore}data.norm}\mbox{}
\normalfont
\end{flushleft}
\begin{verbatim}
## [1] 0.9857
...
By this analysis, there is $\approx 0.98$ probability that the die is fair. Perhaps we should think twice before roughing up the suspected cheater!
...
\[
Pr( fair | data)  = \frac{Pr(data | fair)Pr(fair)}{Pr(data|fair)+ Pr(data|loaded)} = 0.017
\]
...
\[
Pr(fair) = \frac{ 0.017 \cdot \left(Pr(data|fair)+ Pr(data|loaded)\right)}{Pr(data | fair)}
\]
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{pr.fair.pval}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{pd.pval}{\ }\hlkeyword{*}{\ }\hlsymbol{pr.data}\hlkeyword{/}\hlsymbol{pr.data\usebox{\hlnormalsizeboxunderscore}fair}\hspace*{\fill}\\
...
Thus, the prior probabilty of the null must be {\em very low} $Pr(H_0 | Data) = 0.017$ virutally the same value as the $p$ value from before!
...
\hlstd{}\hlsymbol{opts\usebox{\hlnormalsizeboxunderscore}knit}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlfunctioncall{set}\hlkeyword{(}\hlargument{out.format}{\ }\hlargument{=}{\ }\hlstring{"{}latex"{}}\hlkeyword{)}\hspace*{\fill}\\
