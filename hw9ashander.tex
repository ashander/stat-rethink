...
The data include several boys ({\tt Subject}) have ({\tt height}) measured over time ({\tt Age}). 
...
\hlstd{}\hlsymbol{g3}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}point}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{age}\hlkeyword{,}{\ }\hlsymbol{height}\hlkeyword{)}\hlkeyword{)}{\ }\hlkeyword{+}{\ }\hlfunctioncall{facet\usebox{\hlnormalsizeboxunderscore}wrap}\hlkeyword{(}\hlkeyword{\urltilda{}}\hlsymbol{Subject}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{g3}{\ }\hlkeyword{+}{\ }\hlfunctioncall{geom\usebox{\hlnormalsizeboxunderscore}point}\hlkeyword{(}\hlfunctioncall{aes}\hlkeyword{(}\hlsymbol{age}\hlkeyword{,}{\ }\hlsymbol{height}\hlkeyword{,}{\ }\hlargument{size}{\ }\hlargument{=}{\ }\hlsymbol{Subject}\hlkeyword{)}\hlkeyword{)}\mbox{}
\normalfont
\end{flushleft}
...
\hlstd{}\hlfunctioncall{attr}\hlkeyword{(}\hlsymbol{VC}\hlkeyword{,}{\ }\hlstring{"{}stddev"{}}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }random{\ }effects{\ }standard{\ }deviations}\hspace*{\fill}\\
\hlstd{}\hlfunctioncall{attr}\hlkeyword{(}\hlsymbol{VC}\hlkeyword{,}{\ }\hlstring{"{}correlation"{}}\hlkeyword{)}{\ }{\ }\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }random{\ }effects{\ }correlatins}\hspace*{\fill}\\
...
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{nrow}{\ }\hlargument{=}{\ }\hlnumber{2}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
