...
##           1         46.95           156.4    155.8    156.9
##           2         43.72           153.4    152.9    154.0
##           3         64.78           172.5    170.9    174.2
##           4         32.59           143.4    142.3    144.5
##           5         54.63           163.3    162.3    164.2
\end{verbatim}
\end{kframe}}
\end{knitrout}
...
## alpha   58.231    1.39721 55.492 60.969
## beta     2.720    0.06829  2.586  2.854
## sigma    8.437    0.43055  7.593  9.281
\end{verbatim}
\end{kframe}}
\end{knitrout}
...
\centering{}\includegraphics{pi-youth} 
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{pd.f}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{Howell1}\hspace*{\fill}\\
\hlstd{}\hlsymbol{mle.loghw}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{mle2}\hlkeyword{(}\hlsymbol{height}{\ }\hlkeyword{\urltilda{}}{\ }\hlfunctioncall{dnorm}\hlkeyword{(}\hlargument{mean}{\ }\hlargument{=}{\ }\hlsymbol{alpha}{\ }\hlkeyword{+}{\ }\hlsymbol{beta}{\ }\hlkeyword{*}{\ }\hlfunctioncall{log}\hlkeyword{(}\hlsymbol{weight}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
\hlstd{}{\ }{\ }{\ }{\ }\hlargument{sd}{\ }\hlargument{=}{\ }\hlsymbol{sigma}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{data}{\ }\hlargument{=}{\ }\hlsymbol{d.f}\hlkeyword{,}{\ }\hlargument{start}{\ }\hlargument{=}{\ }\hlfunctioncall{list}\hlkeyword{(}\hlargument{alpha}{\ }\hlargument{=}{\ }\hlfunctioncall{mean}\hlkeyword{(}\hlsymbol{d.f}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{weight}\hlkeyword{)}\hlkeyword{,}\hspace*{\fill}\\
...
\hlstd{}{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }\hlnumber{0.95}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlkeyword{\usebox{\hlnormalsizeboxclosebrace}}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }calculate{\ }PI{\ }for{\ }mean}\hspace*{\fill}\\
...
\hlstd{}{\ }{\ }{\ }{\ }{\ }{\ }{\ }{\ }\hlfunctioncall{log}\hlkeyword{(}\hlsymbol{x}\hlkeyword{)}\hlkeyword{)}\hlkeyword{,}{\ }\hlargument{sd}{\ }\hlargument{=}{\ }\hlsymbol{post.full.samples}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{sigma}\hlkeyword{)}\hlkeyword{,}{\ }\hlnumber{0.95}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlkeyword{\usebox{\hlnormalsizeboxclosebrace}}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
\hlstd{}\hlcomment{\usebox{\hlnormalsizeboxhash}{\ }plot{\ }TODO:{\ }clean{\ }this{\ }up,{\ }maybe{\ }rewrite{\ }as{\ }ggplot}\hspace*{\fill}\\
...
\centering{}\includegraphics{all-data} 
