...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{.97, .97, .97}{\color{fgcolor}\begin{kframe}
\includegraphics{trolley-plot-2} \end{kframe}}
\end{knitrout}
...
\normalfont
\end{flushleft}
\includegraphics{mod-avg-age} \end{kframe}}
\end{knitrout}
...
\begin{flushleft}
\ttfamily\noindent
\hlsymbol{min.goals}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{min}\hlkeyword{(}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}{\ }\hlkeyword{-}{\ }\hlsymbol{min.goals}\hspace*{\fill}\\
\hlstd{}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGA}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGA}{\ }\hlkeyword{-}{\ }\hlsymbol{min.goals}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
...
\hlstd{}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{ID}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{seq\usebox{\hlnormalsizeboxunderscore}along}\hlkeyword{(}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{player}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
\hlstd{}\hlsymbol{min.goals}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlfunctioncall{min}\hlkeyword{(}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}\hlkeyword{)}\hspace*{\fill}\\
\hlstd{}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGM}{\ }\hlkeyword{-}{\ }\hlsymbol{min.goals}\hspace*{\fill}\\
\hlstd{}\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGA}{\ }\hlassignement{\usebox{\hlnormalsizeboxlessthan}-}{\ }\hlsymbol{d}\hlkeyword{\usebox{\hlnormalsizeboxdollar}}\hlsymbol{FGA}{\ }\hlkeyword{-}{\ }\hlsymbol{min.goals}\hspace*{\fill}\\
\hlstd{}\hspace*{\fill}\\
...
\begin{verbatim}
##      Estimate Std. Error      2.5%     97.5%
## a   -2.458025  0.1714556 -2.794072 -2.121978
## b    0.001488  0.0002245  0.001048  0.001928
## tau  2.691860  0.1681873  2.362219  3.021501
\end{verbatim}
\end{kframe}}
\end{knitrout}
...
\hlstd{}\hspace*{\fill}\\
\hlstd{}\hlcomment{\usebox{\hlnormalsizeboxhash}min.goals{\ }\usebox{\hlnormalsizeboxlessthan}-{\ }min(d\usebox{\hlnormalsizeboxdollar}FGM)}\hspace*{\fill}\\
